...
class SceneEvents_6 extends SceneScript
{
	...
	public function _event_Drawing(g:G, x:Float, y:Float):Void
	{
		...
		{
			g.drawString("" + Engine.engine.getGameAttribute("coins"), 1230, 15);
			if(((Engine.engine.getGameAttribute("devmode") : Bool) == true))
			{
				g.drawString("" + Engine.engine.getGameAttribute("skinsh"), 1200, 100);
				g.drawString("" + Engine.engine.getGameAttribute("skin"), 1200, 115);
			}
		}
	}
	/* ======================== When Updating ========================= */
