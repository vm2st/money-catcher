...
class ActorEvents_157 extends ActorScript
{
	...
	public function _event_OnActor(mouseState:Int):Void
	{
		...
		{
			if(((Engine.engine.getGameAttribute("newgen") : Bool) == true))
			{
				recycleActor(actor);
				Engine.engine.setGameAttribute("newgen", false);
			}
		}
	}
	/* ======================== When Updating ========================= */
	public function _event_Updating(elapsedTime:Float):Void
	{
		...
		{
			if(((Engine.engine.getGameAttribute("newgen") : Bool) == false))
			{
				recycleActor(actor);
			}
		}
	...
	override public function init()
	{
		...
		runLater(1000 * 10, _event_AfterNsecs, actor);
