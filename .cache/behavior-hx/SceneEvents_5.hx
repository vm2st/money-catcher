...
class SceneEvents_5 extends SceneScript
{
	...
	public function _event_Drawing(g:G, x:Float, y:Float):Void
	{
		if(wrapper.enabled && true)
		{
			...
			{
				g.drawString("" + Engine.engine.getGameAttribute("backgroundglobal"), 1200, 100);
				g.drawString("" + Engine.engine.getGameAttribute("background"), 1200, 115);
			}
		}
	}
